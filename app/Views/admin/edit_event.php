<main class="main-content">
  <div class="container">
    ...
    <form
      action="<?= base_url('events/edit/' . $event['id']) ?>"
      method="post"
      ...
      <div class="mb-3">
        ...
        <input
          ...
          name="title"
          class="form-control"
          value="<?= set_value('title', $event['title']) ?>">
      </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          ...
          <input
            ...
            id="from_date"
            class="form-control"
            value="<?= set_value('from_date', $event['from_date']) ?>"
            required>
        </div>
        ...
        <div class="col-md-6 mb-3">
          ...
          <input
            ...
            id="to_date"
            class="form-control"
            value="<?= set_value('to_date', $event['to_date']) ?>"
            required>
        </div>
      </div>
      ...
      <!-- <div class="mb-3">
        ...
        <textarea
          name="description"
          class="form-control"
          rows="4"><?= set_value('description', $event['description']) ?></textarea>
      </div> -->
          ...
          <?php foreach ($eventImages as $img): ?>
            <div class="border rounded p-3 mb-3">
              ...
              <div class="d-flex justify-content-between align-items-center mb-2">
                <a href="<?= base_url('uploads/events/images/' . $img['image']) ?>"
                   target="_blank"
                   class="text-decoration-none text-primary">
                   <?= esc($img['image']) ?>
                </a>

                <a href="<?= base_url('events/deleteImage/' . $img['id']) ?>"
      ...
      <!-- Dynamic New Image Descriptions -->
      <div id="image-description-container"></div>

      <!-- 🔹 Replace Document -->
      <div class="mb-3">
        <label class="form-label fw-semibold">
          Replace Event Document
        </label>
        <input
          type="file"
          name="event_document"
          ...
          rows="2"
          placeholder="Enter document description"><?= esc($event['document_description'] ?? '') ?></textarea>
      </div>
